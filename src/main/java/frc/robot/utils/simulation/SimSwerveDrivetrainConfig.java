...
public class SimSwerveDrivetrainConfig {
	...
	public Time simPeriod;
	public Pair<Distance, Distance> bumperLengths;
	public Pair<DCMotor, DCMotor> moduleMotors;
	public double wheelCOF;
	public static Translation2d[] moduleLocations;
	public static Pigeon2 pigeon;
	public static SwerveModule<TalonFX, TalonFX, CANcoder>[] modules;
